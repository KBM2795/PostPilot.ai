  ...
  return (
    <footer className="w-full h-fit py-8 px-6 md:px-10 bg-gradient-to-r from-blue-400 to-blue-600 text-primary-foreground">
      ...
      <div className="col-span-1">
        ...
        <ul className="space-y-2">
        <li>
          <Link href="https://twitter.com" className="text-sm opacity-80 hover:opacity-100">
          Twitter
          </Link>
        </li>
        <li>
          <Link href="https://linkedin.com" className="text-sm opacity-80 hover:opacity-100">
          LinkedIn
          </Link>
        </li>
        <li>
          <Link href="https://facebook.com" className="text-sm opacity-80 hover:opacity-100">
          Facebook
          </Link>
        </li>
        </ul>
